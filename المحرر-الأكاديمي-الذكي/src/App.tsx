...
`;
      ...
      if (englishStyle) {
        promptText += `\n\nعينة ترجمة إنجليزية للمحاكاة:\n${englishStyle}`;
      }

      promptText += `\n\nالرجاء صياغة الخبر بناءً على المعطيات أعلاه.`;
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  >
                    ...
                    <option>تغطية عاجلة (Story)</option>
                    <option>برقية إخبارية (نقاط)</option>
          ...
          <Card className="h-full min-h-[600px] flex flex-col">
            ...
            <div className="p-6 flex-1 overflow-auto bg-white">
              {!generatedContent && !isGenerating ? (
                ...
                <div className="prose prose-slate prose-p:leading-relaxed prose-headings:text-[#8B0000] prose-a:text-blue-600 max-w-none rtl">
